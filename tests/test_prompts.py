...
TEMPLATE_CONTRACTS = {
    ...
    "PREDICTOR": ["OBSERVABLE:", "EFFECT_SIZE:", "DISCRIMINATES_FROM:", "MEASURABLE:", "DETECTABLE:"],
    "RED_TEAM": ["ATTACK:", "SEVERITY:", "STATUS:", "TARGET:", "BASIS:"],
    "VALIDATION_DESIGNER": ["TEST:", "CONFIRM_IF:", "REFUTE_IF:", "DISCRIMINATES_FROM:", "INFERENTIAL_STANDARD:", "COST:"],
    "IDEA_COMPLETER": [
        "COMPLETION_STATUS:",
        "COMPLETED_IDEA:",
        "MECHANISM:",
