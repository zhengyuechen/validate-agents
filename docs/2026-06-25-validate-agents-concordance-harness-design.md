...
4. **(residual) Settled-vs-novel distribution gap.** Stratum (ii) + the necessary-not-sufficient licensing sentence (CN-D10/D11) *mitigate and bound* this, but don't eliminate it: stratum (ii) is hard to curate, and even it isn't truly novel (its verdict is now known). The honest residual: passing licenses the unlocks for settled/thin cases; full novel-transfer stays unmeasured. Worth a reviewer's continued attention.
