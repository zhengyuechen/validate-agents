...
- **Date:** 2026-06-24
- **Status:** Design rev 4 (gate-integration corrected to the real scheduler wiring — per-kind paths, say-so credit stripped), approved, pending implementation plan
